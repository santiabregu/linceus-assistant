...
ALIAS_ASIGNATURAS = {
    ...
    'issi1': 'introduccion a la ingenieria del software y los sistemas de informacion i',
    'issi2': 'introduccion a la ingenieria del software y los sistemas de informacion ii',
    'issi': 'introduccion a la ingenieria del software y los si',
