...
\textbf{Decisión:} La tabla \texttt{planes\_docentes} guarda un \textbf{hash SHA-256} de cada PDF procesado. Antes de procesar un documento, se compara el hash actual con el almacenado.
