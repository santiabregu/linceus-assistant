...
RNF-1 & Latencia mediana de respuesta extremo a extremo. & p50 $\leq$ 4~s & Cap.~\ref{cap:pruebas} (3,4~s) \\ \hline
RNF-2 & Latencia en cola larga. & p95 $\leq$ 12~s & Cap.~\ref{cap:pruebas} (10,5~s) \\ \hline
RNF-3 & Coste medio por turno (servicio Gemini). & $\leq$ 0,05~cts & Cap.~\ref{cap:pruebas} (0,012~cts) \\ \hline
RNF-4 & Tasa de éxito en suite de aceptación E2E. & $\geq$ 90~\% & Cap.~\ref{cap:pruebas} (94,3~\%) \\ \hline
RNF-5 & Tasa de éxito sobre tráfico real post-despliegue. & $\geq$ 85~\% & Cap.~\ref{cap:pruebas} (98,3~\%) \\ \hline
...
RNF-11 & Reproducibilidad del despliegue. & \textit{Stack} levantable mediante \texttt{docker compose up}. & Cap.~\ref{cap:manuales} \\ \hline
