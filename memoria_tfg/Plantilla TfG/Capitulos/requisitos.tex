...
RNF-13 & Seguridad panel admin (Basic Auth HTTPS). & HTTP~401 sin credencial en \texttt{/api/admin/*} & \textbf{Cumplido} (HTTP 401) & Verificado manual en despliegue \\ \hline
...
Integrar API Gemini (detección de intenciones y generación de respuestas) &
  RF-A4, RF-A2 (\textit{text-to-SQL}), RF-AD3 (vectorización) \\ \hline
...
La columna \textit{Pruebas} de cada tabla de requisitos funcionales (Secciones \ref{subsec:rf-asignaturas}--\ref{subsec:rf-admin}) proporciona la traza directa de cada RF a su conjunto de casos de aceptación. La Tabla~\ref{tab:traz-rf-pruebas} consolida esta información indicando, para cada dominio, el número de casos de prueba y la tasa de éxito obtenida en el Capítulo~\ref{cap:pruebas}.

\begin{table}[hbtp]
\centering
\small
\caption{Trazabilidad requisitos funcionales -- cobertura de pruebas por dominio.}\label{tab:traz-rf-pruebas}
\begin{tabular}{|p{3.0cm}|p{2.0cm}|p{2.2cm}|p{2.0cm}|p{3.4cm}|}
\hline
\textbf{Dominio} & \textbf{RFs} & \textbf{IDs de prueba} & \textbf{N.\textordmasculine{} casos} & \textbf{Resultado} \\ \hline
Asignaturas & RF-A1 -- RF-A6 & E-P*, L-P*, C-P*, RAG-P*, E-S* & 85 & 80/85 PASS (94,1~\%) \\ \hline
Horarios & RF-H1 -- RF-H7 & H-P*, H-PC*, H-N*, HA-P* & 35 & 34/35 PASS (97,1~\%) \\ \hline
Profesorado & RF-P1 -- RF-P7 & P-P*, P-PA*, P-T*, P-W*, P-N*, P-S* & 39 & 36/39 PASS (92,3~\%) \\ \hline
Transversal & RF-T1 -- RF-T6 & CC-P*, CC-N*, F-0*, R-0* & 16 & 16/16 PASS (100~\%) \\ \hline
\textbf{Total E2E} & \textbf{RF-A -- RF-T} & --- & \textbf{159} & \textbf{150/159 PASS (94,3~\%)} \\ \hline
Panel admin. & RF-AD1 -- RF-AD7 & AD-*, SINC-*, PLAN-* & 18 & Cobertura parcial (\S\ref{sec:pruebas-admin}) \\ \hline
\end{tabular}
\end{table}
