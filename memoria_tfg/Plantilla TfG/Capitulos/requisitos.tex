...
% TODO: añadir capturas reales del widget en distintos estados.
\begin{figure}[hbtp]
\centering
\fbox{\parbox{0.7\textwidth}{\centering \vspace{2cm} \textit{[Placeholder: captura del \textit{widget} de chat con un turno típico, mostrando el selector de titulación y un par de mensajes de ejemplo.]} \vspace{2cm}}}
\caption{Widget conversacional accesible para el estudiante.}\label{fig:widget-chat}
\end{figure}

% TODO: capturas del panel admin: vista jerárquica de asignaturas, conversaciones, horarios, profesores.
\begin{figure}[hbtp]
\centering
\fbox{\parbox{0.7\textwidth}{\centering \vspace{2cm} \textit{[Placeholder: captura del panel de administración mostrando la vista jerárquica Centro $\rightarrow$ Titulación $\rightarrow$ Asignatura.]} \vspace{2cm}}}
\caption{Panel de administración: gestión de asignaturas.}\label{fig:admin-asignaturas}
\end{figure}

\begin{figure}[hbtp]
\centering
\fbox{\parbox{0.7\textwidth}{\centering \vspace{2cm} \textit{[Placeholder: captura del panel de administración mostrando la auditoría de conversaciones y \textit{feedback}.]} \vspace{2cm}}}
\caption{Panel de administración: auditoría de conversaciones.}\label{fig:admin-conversaciones}
\end{figure}

\begin{figure}[hbtp]
\centering
\fbox{\parbox{0.7\textwidth}{\centering \vspace{2cm} \textit{[Placeholder: captura del panel de administración mostrando la vista de horarios cargados por curso y grupo.]} \vspace{2cm}}}
\caption{Panel de administración: gestión de horarios.}\label{fig:admin-horarios}
\end{figure}

\begin{figure}[hbtp]
\centering
\fbox{\parbox{0.7\textwidth}{\centering \vspace{2cm} \textit{[Placeholder: captura del panel de administración mostrando la vista jerárquica Centro $\rightarrow$ Departamento $\rightarrow$ Profesor.]} \vspace{2cm}}}
