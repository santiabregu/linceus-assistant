...
\begin{enumerate}
    ...
    \item \textbf{Calibración empírica y trazable de los umbrales del sistema.} Los tres umbrales que determinan la calidad de las respuestas (umbral de fallback NLU, umbrales firme y de sugerencia del \textit{fuzzy matching}, umbral de similitud coseno del RAG) se han calibrado empíricamente sobre conjuntos de prueba reales, no se han fijado por convención. El procedimiento más representativo, descrito en la Sección~\ref{sec:impl-shared}, evaluó 120 casos de profesorado a lo largo de tres iteraciones del sprint S4 hasta seleccionar la combinación 0,60 / 0,30 que alcanza \textit{precision} 92~\% y \textit{recall} 88~\%. El registro completo de la calibración figura en \texttt{docs/sprints/} y es la base que permite defender los porcentajes del Capítulo~\ref{cap:pruebas} como decisiones reproducibles y no como ajustes ad hoc.
