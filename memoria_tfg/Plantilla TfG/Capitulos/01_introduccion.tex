...
\begin{itemize}
    ...
    \item Diseñar y desarrollar una base de datos híbrida en Supabase que combine información estructurada (horarios, profesorado, trámites) con embeddings vectoriales para búsquedas semánticas.
    ...
    \item Implementar un frontend web en React que ofrezca una interfaz intuitiva y accesible para la interacción con el chatbot.
    \item Garantizar el cumplimiento de normativas de privacidad (RGPD) mediante despliegue local y control de acceso a datos sensibles.
\end{itemize}
