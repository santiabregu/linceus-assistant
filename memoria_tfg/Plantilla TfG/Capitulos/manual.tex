...
git clone https://github.com/santiabregu/linceus-assistant && cd linceus-assistant
...
El manual de desarrollo se dirige a quien deba modificar, ampliar o mantener el código de Linceus Assistant tras el cierre de este TFG. Su objetivo es minimizar la curva de aprendizaje proporcionando una visión panorámica del repositorio, las convenciones empleadas y el ciclo de trabajo recomendado. El código fuente completo del proyecto está alojado en GitHub bajo \href{https://github.com/santiabregu/linceus-assistant}{\texttt{https://github.com/santiabregu/linceus-assistant}} y es la referencia autoritativa para cualquier divergencia con esta memoria.
