...
\begin{enumerate}
    \item \textbf{NLU}: el texto se tokeniza, se vectoriza y se clasifica para obtener el intent y las entidades. En el proyecto, esta etapa combina el clasificador DIET de Rasa con una llamada opcional a la API de Gemini para los casos en que la confianza del clasificador local no supera el umbral definido.
