...
El primero es el \textbf{tipo de información cubierta}. Los asistentes institucionales españoles (CATi, Lola, Alhe, LUCA, Isidra) se concentran fundamentalmente en el ciclo de captación, acceso y matrícula, es decir, en información de tipo administrativo dirigida a estudiantes potenciales o de nuevo ingreso. Linceus Assistant, en cambio, atiende al estudiante ya matriculado en su día a día académico: consulta de asignaturas con su plan docente, horarios por curso y grupo, e información de contacto del profesorado. Es un dominio menos atendido por las soluciones comerciales y, por tanto, con un nicho funcional propio.

El segundo es el \textbf{modelo conversacional}. La interacción real con CATi expuesta al inicio de esta sección demuestra que la mayoría de los asistentes universitarios españoles desplegados a fecha de hoy combinan una primera capa NLU con un \textit{flujo guiado por menús} en los turnos posteriores. Esta arquitectura limita la cobertura efectiva al conjunto cerrado de preguntas predefinidas. Linceus Assistant adopta un planteamiento distinto: emplea un módulo de recuperación aumentada por generación (RAG) sobre los documentos oficiales, lo que le permite responder a preguntas no anticipadas en el guion siempre que la información figure en el corpus indexado. La validación recogida en el Capítulo~\ref{cap:pruebas} muestra que el sistema responde correctamente al 91,9\,\% de un conjunto de 74 preguntas reales extraídas de los planes docentes oficiales, lo que excede el rango habitual de \textit{exact-match} reportado para sistemas RAG de dominio cerrado en la literatura.
...
En conjunto, el panorama revisado muestra que existe espacio para una propuesta como la presente: enfocada al estudiante matriculado, abierta en su tecnología, basada en RAG sobre documentación oficial real y validada con un esquema cuantitativo reproducible.
