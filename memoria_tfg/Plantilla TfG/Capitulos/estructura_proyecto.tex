...
\begin{itemize}
    ...
    \item \textbf{Escalabilidad}: Añadir soporte para nuevas épicas (profesores, horarios, trámites) implica crear nuevos ficheros en \texttt{actions/} y ampliar los datos en \texttt{data/nlu/}, sin modificar la arquitectura existente.
