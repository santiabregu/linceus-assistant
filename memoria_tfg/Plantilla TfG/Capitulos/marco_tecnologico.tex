...
Este capítulo describe el conjunto de tecnologías, frameworks y paradigmas que conforman la base técnica del proyecto LinceUS Assistant. Se detallan las decisiones arquitectónicas tomadas y se justifica la elección de cada componente del stack tecnológico.

\section{Arquitectura del sistema}\label{sec:arquitectura}

LinceUS Assistant se estructura en tres capas principales:

\begin{enumerate}
    \item \textbf{Capa de presentación}: Interfaz web desarrollada en Node.js que permite la interacción del usuario con el asistente.
    \item \textbf{Capa de procesamiento conversacional}: Motor Rasa que gestiona el flujo de diálogo, comprensión de intenciones y ejecución de acciones.
    \item \textbf{Capa de datos}: Base de datos PostgreSQL (Supabase) que almacena información académica, vectores de embeddings y configuraciones.
\end{enumerate}

% TODO: Descomentar cuando se genere la imagen
% \figura{0.8}{img/arquitectura}{Arquitectura general del sistema LinceUS Assistant}{fig:arquitectura}{}
