...
2) Se definó el scope para asignaturas ( ing software - etsii)
3) Se defino la esquema de la base de datos para todo el proyecto ( esquema inicial )
4) Se insertaron los datos iniciales ( documento tfg_chatbot_resumen_datos.md)
5) Se ha definido logica de versionado
6) Se decidió separar los datos de entrenamiento nlu segun epicas
