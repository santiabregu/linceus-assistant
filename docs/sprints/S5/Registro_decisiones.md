...
### S5-01: Fix de alias con prefijos NLU
...
### S5-02: Test E-T03 — no exigir que pida titulación
...
### S5-03: Nuevos ejemplos NLU para "todas las asignaturas" (Plan v1, punto 3)
...
### S5-04: Nuevos ejemplos NLU para conteo con "carrera"/"grado" (Plan v1, punto 4)
...
### S5-05: Intent `out_of_scope` + threshold de fallback (Plan v1, punto 6)
...
### S5-06: Corrección de expected_count en tests (Plan v2, punto 4)
...
### S5-07: Validación de tests fallback acepta `out_of_scope` (Plan v2, punto 6)

**Problema:** Tests F-01 a F-04 esperaban `nlu_fallback` pero obtienen `out_of_scope` tras S5-05.
...
### S5-08: Fallback con búsqueda por código + SELECT ALL (Plan v2, punto 2)
...
### S5-09: Ejemplos de asignaturas genéricas para mejorar robustez NLU (Plan v2, punto 3)
...
### S5-10: Regex feature para distinguir conteo de listado (Plan v2, punto 5)
...
### S5-11: No unir intents/actions de listado y conteo
...
### S5-12: No implementar RegexEntityExtractor para acrónimos (Plan v2, punto 1)
...
### S5-13: Actualizar `utter_default` con enlaces útiles (Plan v2, punto 7)
...
### S5-14: Fallback fuzzy cuando ILIKE falla con nombre extraído por NLU
...
### S5-15: Mejora de `_resolver_nombre_desde_texto` con ventanas de palabras
...
### S5-16: Reordenación de resultados SQL por `token_set_ratio`
...
### S5-18: Ampliación del diccionario de alias `ALIAS_ASIGNATURAS`
...
### S5-19: Reformulación de preguntas de test para testing realista
...
- Re-entrenar modelo NLU (`rasa train`) para que surtan efecto los cambios de S5-03, S5-04, S5-05, S5-09, S5-10
- Reiniciar action server para que surtan efecto S5-14 a S5-18
