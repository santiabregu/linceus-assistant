...
| E-P10 | Dame info del TFG | consulta_asignatura_especifica | 1.00 | 0/2 | FAIL | Esperaba contener 'Trabajo Fin de Grado'. Response: 'el tfg que buscas es "funda |
...
| E-S01 | ¿Y cuántos créditos tiene? | consulta_asignatura_especifica | 1.00 | 0/2 | FAIL | Esperaba contener '12'. Response: 'tiene 6 ects.'.  |
| E-S02 | ¿Es obligatoria? | consulta_asignatura_especifica | 1.00 | 2/2 | PASS |  |
| E-S03 | ¿Y esa de qué curso es? | consulta_asignatura_especifica | 1.00 | 0/2 | FAIL | Esperaba contener '1'. Response: 'es de 4º curso.'.  |
...
- **Entity esperada:** nombre_asignatura=TFG
- **Contiene esperado:** "Trabajo Fin de Grado"

- **Run 1**: intent=consulta_asignatura_especifica (conf=1.00), intent_ok=True, entity_ok=True, response_ok=False
  - Respuesta: El TFG que buscas es "Fundamentos Físicos de la Informática" y tiene las siguientes características:
  - Notas: Esperaba contener 'Trabajo Fin de Grado'. Response: 'el tfg que buscas es "fundamentos físicos de la informática" y tiene las siguientes características: *   **código:** 2050004
*   **curso:** 1º
*   **créditos:** 6.0 ects
*   **duración:** primer cuatr'. 
...
- **Intent esperado:** consulta_asignatura_especifica
- **Contiene esperado:** "12"

- **Run 1**: intent=consulta_asignatura_especifica (conf=1.00), intent_ok=True, entity_ok=True, response_ok=False
  - Respuesta: Tiene 6 ECTS.
  - Notas: Esperaba contener '12'. Response: 'tiene 6 ects.'. 
- **Run 2**: intent=consulta_asignatura_especifica (conf=1.00), intent_ok=True, entity_ok=True, response_ok=False
  - Respuesta: Tiene 6 ECTS.
  - Notas: Esperaba contener '12'. Response: 'tiene 6 ects.'. 
...
- **Run 1**: intent=consulta_asignatura_especifica (conf=1.00), intent_ok=True, entity_ok=True, response_ok=False
  - Respuesta: Es de 4º curso.
  - Notas: Esperaba contener '1'. Response: 'es de 4º curso.'. 
- **Run 2**: intent=consulta_asignatura_especifica (conf=1.00), intent_ok=True, entity_ok=True, response_ok=False
  - Respuesta: Es de 4º curso.
  - Notas: Esperaba contener '1'. Response: 'es de 4º curso.'. 
