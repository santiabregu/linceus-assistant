...
| E-T02 | Info de IA | consulta_asignatura_especifica | 1.00 | 0/2 | FAIL | Esperaba contener 'Inteligencia Artificial'. Response: 'no encontré ninguna asig |
| E-T04 | Dime sobre Redes en ingeniería del software | cambiar_contexto_academico | 0.72 | 0/3 | FAIL | Esperaba contener 'Redes'. Intent: esperado=consulta_asignatura_especifica, obte |
...
- **Run 1**: intent=consulta_asignatura_especifica (conf=1.00), intent_ok=True, entity_ok=True, response_ok=False
  ...
  - Notas: Esperaba contener 'Inteligencia Artificial'. Response: 'no encontré ninguna asignatura llamada 'info de' en grado en ingeniería informática - tecnologías informáticas.'. 
...
- **Run 1**: intent=cambiar_contexto_academico (conf=0.72), intent_ok=False, entity_ok=True, response_ok=False
  ...
  - Notas: Esperaba contener 'Redes'. Intent: esperado=consulta_asignatura_especifica, obtenido=cambiar_contexto_academico (0.72). Response: '✅ cambiado a: grado en ingeniería informática - ingeniería del software ahora las consultas de asignaturas serán de esta titulación.'. 
