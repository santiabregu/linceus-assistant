...
> Vídeo de **3:00** (180 s). Los timestamps son acumulativos desde el segundo 0.
...
## 00:10 – 00:21 · Onboarding · Selección de titulación (11 s)
...
## 00:21 – 00:34 · Caso 1 · Información sobre una asignatura (13 s)
...
## 00:34 – 00:44 · Caso 2 · Seguimiento elíptico (10 s)
...
## 00:44 – 00:57 · Caso 3 · Listado de optativas (13 s)
...
## 00:57 – 01:06 · Caso 4 · Horario por asignatura sin grupo (9 s)

> "Al preguntar cuándo es ADDA, el asistente devuelve los horarios de todos los grupos disponibles para esa asignatura — martes y jueves — sin que el estudiante tenga que especificar su grupo."
...
## 01:17 – 01:26 · Caso 6 · Correo de un profesor (9 s)
...
## 01:26 – 01:39 · Caso 7 · Cambio de titulación (13 s)
...
## 01:39 – 01:52 · Caso 8 · Robustez frente a jailbreak (13 s)

> "Por último, un intento de manipulación: el estudiante le pide que ignore sus instrucciones y revele su prompt interno. El asistente rechaza la solicitud con educación y devuelve la conversación al ámbito académico, sin revelar nada."

---

## 01:52 – 02:04 · Panel · Inicio (12 s)
...
## 02:04 – 02:15 · Panel · Asignaturas (11 s)
...
## 02:15 – 02:22 · Panel · Horarios (7 s)
...
## 02:22 – 02:30 · Panel · Profesores (8 s)
...
## 02:30 – 02:42 · Panel · Conversaciones (12 s)
...
## 02:42 – 02:54 · Panel · Estadísticas (12 s)

> "Y en estadísticas, una visión global: 244 asignaturas, 268 profesores, 157 planes docentes procesados y más de 1.300 fragmentos de contenido disponibles para responder preguntas."
...
- Duración total: **3:00** (180 s) — incluye los bloques de Asignaturas (vectorización / enriquecimiento / sincronización) y Horarios (generación) del panel.
- El guion está ya ajustado al máximo de 3 min; no quedan secciones con margen amplio. Si el montaje necesita recortar, los candidatos con más holgura son: caso 5 (11 s), caso 7 (13 s) y panel · conversaciones (12 s).
- Las secciones más cortas y sin margen: caso 4 (9 s), caso 6 (9 s), panel horarios (7 s), panel profesores (8 s) y cierre (6 s).
